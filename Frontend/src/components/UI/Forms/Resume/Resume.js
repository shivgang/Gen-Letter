...
function Resume() {
    ...
    useEffect(() => {
        if (id) {
            axios.get(`https://genletter-pa28.onrender.com/edit/resume/${id}`)
                .then((response) => {
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch("https://genletter-pa28.onrender.com/resume", {
            method: "POST",
            headers: {
    ...
    switch (index) {
        ...
        case 7: content = (
            ...
            break;
        case 8: content = (
            <POR onChange={handleArrayChange} title='Positions of Responsibility' nextStep={nextStep} prevStep={prevStep}  values={refs} increase={fieldArrayAddHandler} decrease={fieldRemoveHandler} increaseLink={linkIncreaseHandler} decreaseLink={linkDecreaseHandler} onChangeLink={handleLinkChange} />
        );
            break;
        case 9: content = (
            <ResumeType onChange={handleArrayChange} type={handleType} title='Resume Type' nextStep={nextStep} prevStep={prevStep} formSubmitted={handleSubmit} values={refs} increase={fieldArrayAddHandler} decrease={fieldRemoveHandler} increaseLink={linkIncreaseHandler} decreaseLink={linkDecreaseHandler} onChangeLink={handleLinkChange} />
        );
            break;
